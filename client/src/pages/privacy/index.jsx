  ...
  return (
    <>
      <div className="bg-[#3D6A70] py-[24px]">
        <h1 className="text-[56px] font-bold max-w-[1280px] w-full mx-auto px-[32px] 2xl:px-0">
          Privacy policy
        </h1>
      </div>
        ...
        <div className="font-medium my-[56px] flex flex-col w-full gap-[24px] [&_ul]:pl-[20px] [&_ul]:flex [&_ul]:flex-col [&_ul]:w-full [&_ul]:gap-[12px]">
          ...
          <ul className="list-disc">
            ...
            <li>
              ...
              in this Agreement) refers to Monstertap.
            </li>
            <li>
            ...
            <li>
              Website refers to Monstertap, accessible from
              http://monstertapcoin.comCollecting and Using Your Personal Data
            </li>
          </ul>
          ...
          <p>
            ...
            mobile device Tracking Technologies and Cookies
          </p>
          ...
          <p>
            ...
            such information represents Your agreement to that
          </p>
        </div>
      </MaxContainer>
    </>
