        ...
        <div className="relative overflow-hidden h-fit">
          <MaxContainer>
            <div className=" relative flex items-center justify-between w-full gap-[48px]">
              <div className="w-[48%] h-[500px] bg-[#63BBC282] rounded-[44px]">
                <img
                  src={walking}
                  alt=""
              ...
              <div className="w-full flex-shrink-0 text-right pl-[32px] relative z-[2] max-w-[500px]">
          ...
          <img
            src={wolfHead}
            alt=""
            className="opacity-60 absolute w-[700px] h-[500px] object-contain right-[-250px] top-[20px]"
          />
        </div>
        <div className="relative overflow-hidden h-fit ">
          <MaxContainer>
            <div className=" relative flex items-center flex-row-reverse justify-between w-full gap-[48px]">
              <div className="w-[48%] h-[500px] overflow-hidden bg-[#63BBC282] rounded-[44px] relative">
                <img
                  src={laying}
                  alt=""
              ...
              <div className="w-full flex-shrink-0 text-left pl-[32px] relative z-[2] max-w-[500px]">
                <h3 className="text-[34px] font-bold text-[#E4E1F8]">
                  Mobile friendly
                </h3>
                <p className="text-[#969799] text-[20px]">
          ...
          <img
            src={wolfHead}
            alt=""
            className="opacity-60 absolute w-[700px] h-[500px] object-contain left-[-250px] top-[20px] scale-x-[-1]"
          />
        </div>
        <div className="relative overflow-hidden h-fit">
          <MaxContainer>
            <div className=" relative flex items-center justify-between w-full gap-[48px]">
              <div className="relative w-[48%] h-[500px] bg-[#63BBC282] rounded-[44px]">
                <img
                  src={jumping}
                  alt=""
